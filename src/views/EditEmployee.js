...
const EditEmployee = (props) => {
    ...
    const getData = async () => {
        let path = apiUrl.get_signle_empolyee + '/' + `${props.match.params.id}`;
                                    ...
                                    <Row>
                                        <Col md={12}>
                                            <FormGroup>
                                                ...
                                                <input type="text" name="name" placeholder="Name" autoComplete="off" value={UserData.name}
                                        ...
                                        <FormGroup>
                                            ...
                                            <input type="text" name="email" className="form-control  col-md-8" placeholder="Email" value={UserData.email}
                                                {...register('email', {
                                        ...
                                        <Col md={12}>
                                            <FormGroup>
                                                ...
                                                <input type="number" name="age" placeholder="Age" autoComplete="off" value={UserData.age}
                                                    className="form-control col-md-8" {...register('age', { required: true, pattern: /^[A-Za-z]+$/i })} />
                                                {errors.name && <p className="text-danger marginmessage">Name is required</p>}
                                            </FormGroup>
                                        </Col>
                                        <FormGroup>
